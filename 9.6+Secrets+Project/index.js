...
app.post("/submit", async (req, res) => {
  ...
  try{
await db.query("UPDATE users SET secret=$1 WHERE email=$2", [newSecret, req.user.email]); //on both strategies the results are returned as user so we can use this ability to access the logged in user.See passport.serialize/deserializeUser.
